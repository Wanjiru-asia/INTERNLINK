...
- **Polished UI/UX**: A modern, responsive interface featuring glassmorphism, fluid animations (Framer Motion), and interactive elements.
- **Immersive Backgrounds**: Engaging visual experience using high-performance particle systems.
- **Secure Authentication**: Robust login and signup systems with password privacy and character-based feedback animations.
- **Profile Management**: Detailed academic and professional profiles including skills, tools, and background across various disciplines.

## 🛠️ Tech Stack
### Frontend
- **React.js**: Core UI library for building a dynamic and responsive interface.
- **Tailwind CSS**: Utility-first CSS framework for rapid and consistent styling.
- **Framer Motion**: Powering fluid and interactive animations.
- **Lucide React**: A beautiful and consistent icon library.
- **Vite**: Modern build tool for a fast and optimized developer experience.

### Backend
- **Node.js & Express**: Scalable and efficient server-side architecture.
- **MySQL**: Relational database for persistent storage of user profiles and application data.
- **Bcrypt**: Ensuring industry-standard security for password hashing.
