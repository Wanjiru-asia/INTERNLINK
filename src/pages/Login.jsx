                            ...
                            <form onSubmit={handleSubmit} className="space-y-6 relative">
                                <div className="relative group">
                                    <input
                                        ...
                                        placeholder=" "
                                        required
                                        className="w-full h-16 pt-5 px-4 bg-[#0f172a] border-2 border-[#334155] focus:border-[#10b981] rounded-xl outline-none transition-all font-medium text-white peer placeholder-transparent focus:shadow-[0_0_0_4px_rgba(16,185,129,0.2)]"
                                    />
                                    <label
                                        htmlFor="email"
                                        className="absolute left-4 top-5 text-slate-400 text-sm font-semibold transition-all peer-focus:-translate-y-3.5 peer-focus:scale-75 peer-focus:text-emerald-500 peer-[:not(:placeholder-shown)]:-translate-y-3.5 peer-[:not(:placeholder-shown)]:scale-75 pointer-events-none"
                                    >
                                        Email Address
                                    </label>
                                </div>
                                ...
                                <div className="relative group">
                                    <input
                                        ...
                                        placeholder=" "
                                        required
                                        className="w-full h-16 pt-5 px-4 pr-12 bg-[#0f172a] border-2 border-[#334155] focus:border-[#10b981] rounded-xl outline-none transition-all font-medium text-white peer placeholder-transparent focus:shadow-[0_0_0_4px_rgba(16,185,129,0.2)]"
                                    />
                                    <label
                                        htmlFor="password"
                                        className="absolute left-4 top-5 text-slate-400 text-sm font-semibold transition-all peer-focus:-translate-y-3.5 peer-focus:scale-75 peer-focus:text-emerald-500 peer-[:not(:placeholder-shown)]:-translate-y-3.5 peer-[:not(:placeholder-shown)]:scale-75 pointer-events-none"
                                    ...
                                    <button
                                        ...
                                        className={`absolute right-4 top-5 transition-colors ${showPassword ? 'text-emerald-500' : 'text-slate-400 hover:text-emerald-500'}`}
                                    >
